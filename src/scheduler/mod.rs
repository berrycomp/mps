...
impl MpsScheduler {
    ...
    pub fn new() -> Self {
        ...
        eprintln!(
            "[mps] cores={} (P={} E={} U={}) hybrid={} vendor={} simd={:?} lanes={} workers={}",
            ...
            topology.simd.backend,
            topology.simd.simd_lanes,
            topology.logical_cores,
        );
    ...
    /// Return the SIMD backend selected for this scheduler.
    pub fn simd_backend(&self) -> SimdBackendKind {
        self.topology.simd.backend
    }
    ...
    pub fn metrics(&self) -> SchedulerMetrics {
        ...
        SchedulerMetrics {
            ...
            efficient,
            unknown,
            simd_backend: self.topology.simd.backend,
            simd_lanes: self.topology.simd.simd_lanes,
        }
    }
